                    ...
                    <div class="card py-3 px-4 border-0 shadow-1 rounded-16" style="margin-bottom: 140px;">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="text-center">
                                <button type="submit" name="edit_alamat" class="btn btn-green fw-500 w-100 d-lg-none d-block">Simpan</button>
                                <button type="submit" name="edit_alamat" class="btn btn-green fw-500 w-50 d-none d-lg-inline">Simpan</button>
                            </div>
                        </form>
                    </div>
                </div>
